...
./setup-client-softhsm.sh <name>           # import client key+cert into client SoftHSM token
```
...
The client module loads its runtime identity from HSM (PKCS#11), not from `.p12`.
